...
public class ArgumentParserTest {
    ...
    public void whenNotFlagFReturnLogFile() {
        String[] args = new String[]{"C:\\Users\\123\\Documents\\JavaLige\\day_5\\dz 5\\liga-internship\\zombie.txt", "analize"};
        App.main(args);
    ...
    public void whenHaveChangeReturnChangeMidiFile() {
        String[] args = new String[]{"C:\\Users\\123\\Documents\\JavaLige\\day_5\\dz 5\\liga-internship\\zombie.txt", "change", "-trans", "2", "-tempo", "20"};
        App.main(args);
        File file = new File("C:\\Users\\123\\Documents\\JavaLige\\day_5\\dz 5\\liga-internship\\zombi-trans2-tempo20.mid");
        assertThat(file.exists()).isEqualTo(true);
    }
}